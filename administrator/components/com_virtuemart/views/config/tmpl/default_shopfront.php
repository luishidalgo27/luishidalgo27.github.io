 ...
 * @version $Id: default_shopfront.php 10721 2022-10-23 20:48:35Z Milbo $
 */
...
<?php
	...
	echo VmHTML::row('checkbox','COM_VIRTUEMART_UNCAT_CHILD_PRODUCTS_SHOW','show_uncat_child_products',VmConfig::get('show_uncat_child_products',1));
