...
* @version $Id: view.html.php 10755 2022-11-29 22:25:56Z Milbo $
*/
...
//$bar->appendButton( 'publish', 'upload', $alt, '', 550, 400 );
	...
	function renderUserfieldPlugin(){
		...
		if (file_exists($formFile)){
			...
			$form = JForm::getInstance($this->userField->element, $formFile, array(),false, '//vmconfig | //config[not(//vmconfig)]');
			...
			$form->bind($this->userField->getProperties());
			$this->userField->form = $form;
		} else {
