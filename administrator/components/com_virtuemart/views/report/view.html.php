...
/**
 *
 * @version $Id: view.html.php 10740 2022-11-14 09:30:56Z Milbo $
 * @package VirtueMart
 * @subpackage Report
...
class VirtuemartViewReport extends VmViewAdmin {
	...
	function display($tpl = null){
		...
		$orderstates = vRequest::getVar ('order_status_code', VmConfig::get('revenue_report_statuses', array('C','S','F') ));
