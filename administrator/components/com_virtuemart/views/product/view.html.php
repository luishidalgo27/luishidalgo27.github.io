 ...
 * @version $Id: view.html.php 10766 2022-12-05 19:38:39Z Milbo $
 */
...
class VirtuemartViewProduct extends VmViewAdmin {
	...
	function display($tpl = null) {
		...
		default:
			...
			$this->lists['list_published'] = VmHTML::selectList('list_published', $model->list_published, $opt,1,false,'class="changeSendForm"');
