...
* @version $Id: userinfos.php 10730 2022-10-27 20:20:47Z Milbo $
*/
...
// 	var $zip = '';
	...
	*/
	public function check(){
		...
		$hash = 'SFL'.$this->_tbl.'00';

		if (isset(self::$_cache[$hash])) {
			foreach(self::$_cache[$hash] as $field){

				if( strpos( $field['Type'],'int')!==false and $this->{$field['Field']}!=null){

					if( empty($this->{$field['Field']}) ){
						vmdebug(' int field to 0',$field['Field'],$this->{$field['Field']});
						$this->{$field['Field']} = 0;
					} else {
