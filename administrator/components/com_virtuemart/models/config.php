 ...
 * @version $Id: config.php 10772 2022-12-19 19:51:06Z Milbo $
 */
...
class VirtueMartModelConfig extends VmModel {
	...
	static public function checkVirtuemartInstalled(){
		...
		if(!empty($err) or !$vmTables or count($vmTables)<55 or !in_array($db->getPrefix().'virtuemart_config',$vmTables)){	//62 tables for a normal installation
			return false;
		} else {
			return true;
		}
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Holds configuration settings' AUTO_INCREMENT=1 ;";
	}
