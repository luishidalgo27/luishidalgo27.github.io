...
class VirtueMartModelCoupon extends VmModel {
    ...
    function store(&$data) {
		...
		/* Changes Modified */
		$data['virtuemart_shopper_ids'] = is_array($data['virtuemart_shopper_ids'])? implode(',',$data['virtuemart_shopper_ids']):$data['virtuemart_shopper_ids'];
		$data['virtuemart_shoppergroup_ids'] = is_array($data['virtuemart_shoppergroup_ids'])? implode(',',$data['virtuemart_shoppergroup_ids']):$data['virtuemart_shoppergroup_ids'];
		$data['virtuemart_product_ids'] = is_array($data['virtuemart_product_ids'])? implode(',',$data['virtuemart_product_ids']):$data['virtuemart_product_ids'];
		$data['virtuemart_category_ids'] = is_array($data['virtuemart_category_ids'])? implode(',',$data['virtuemart_category_ids']):$data['virtuemart_category_ids'];
