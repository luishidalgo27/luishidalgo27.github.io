...
<script type="text/javascript" src="<?php echo $template_path?>/tt_animation.js">
</script>
<!--[if IE 7]>
...
<img <?php if($params->get('site_logo_Image')!=""):?> src="<?php echo $params->get('site_logo_Image');?>" <?php else: ?> src="<?php echo (JURI::base() . 'templates/' . $app->getTemplate().'/logo.png')?>" <?php endif; ?> class="ttr_header_logo" alt="logo" class="" />
<?php endif; ?>
...
<div class="margin_collapsetop"></div>
<?php
if(  count(JModuleHelper::getModules('CAxyz00'))||  count(JModuleHelper::getModules('CAxyz01'))||  count(JModuleHelper::getModules('CAxyz02'))||  count(JModuleHelper::getModules('CAxyz03'))):
?>
<div class="contenttopcolumn0">
<?php
$showcolumn= count(JModuleHelper::getModules('CAxyz00'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="topcolumn1">
<jdoc:include type="modules" name="CAxyz00" style="<?php if($params->get('CAxyz00') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CAxyz01'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="topcolumn2">
<jdoc:include type="modules" name="CAxyz01" style="<?php if($params->get('CAxyz01') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:left;background-color:transparent;">
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CAxyz02'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="topcolumn3">
<jdoc:include type="modules" name="CAxyz02" style="<?php if($params->get('CAxyz02') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:left;background-color:transparent;">
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CAxyz03'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:right;">
<div class="topcolumn4">
<jdoc:include type="modules" name="CAxyz03" style="<?php if($params->get('CAxyz03') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
...
<?php
if(  count(JModuleHelper::getModules('CBxyz00'))||  count(JModuleHelper::getModules('CBxyz01'))||  count(JModuleHelper::getModules('CBxyz02'))||  count(JModuleHelper::getModules('CBxyz03'))):
?>
<div class="contentbottomcolumn0">
<?php
$showcolumn= count(JModuleHelper::getModules('CBxyz00'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="bottomcolumn1">
<jdoc:include type="modules" name="CBxyz00" style="<?php if($params->get('CBxyz00') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:left;background-color:transparent;">
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CBxyz01'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="bottomcolumn2">
<jdoc:include type="modules" name="CBxyz01" style="<?php if($params->get('CBxyz01') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:left;background-color:transparent;">
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CBxyz02'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:left;">
<div class="bottomcolumn3">
<jdoc:include type="modules" name="CBxyz02" style="<?php if($params->get('CBxyz02') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:left;background-color:transparent;">
...
<?php endif; ?>
<?php
$showcolumn= count(JModuleHelper::getModules('CBxyz03'));
?>
<?php if($showcolumn): ?>
<div style="width:3%;float:right;">
<div class="bottomcolumn4">
<jdoc:include type="modules" name="CBxyz03" style="<?php if($params->get('CBxyz03') == 'block'): echo "block"; else: echo "xhtml"; endif;?>"/>
</div>
</div>
<?php else: ?>
<div style="width:3%;float:right;background-color:transparent;">
