...
<a href="" class="" target="_self" data-effect="Fade" data-begintime="2" data-duration="3" data-easing="linear" data-slide="None">
</a>
<div class="ttr_slideshowshape01" data-effect="Fade" data-begintime="3" data-duration="2" data-easing="linear" data-slide="None">
<div class="html_content"><p style="margin:5px 0px 20px 0px;line-height:2.86em;"><span style="font-weight:600;font-size:2.5em;color:rgba(255,255,255,1);background-color:purple;">&nbsp;&nbsp;Gimnasio Hidalgo&nbsp;&nbsp;</span></p><p style="margin:5px 0px 10px 0px;"><span style="font-size:1.714em;color:white;">¡Compra tus productos de GYM baratísimos!</span></p><p style="margin:5px 0px 40px 0px;"><span style="font-weight:600;font-size:2.286em;color:purple;">¡Con tu 20% de descuento!</span></p><p style="margin:5px 0px 30px 0px;"><span><a href="index.php/tienda" target="_self" class="btn btn-md btn-default">Compra Ahora</a></span></p><p><br style="font-size:1.714em;color:rgba(52,52,52,1);" /></p></div>
</div>
<div class="ttr_slideshowshape02" data-effect="None" data-begintime="0" data-duration="1" data-easing="linear" data-slide="None">
...
<div class="ttr_slideshowshape11" data-effect="Fade" data-begintime="3" data-duration="2" data-easing="linear" data-slide="None">
<div class="html_content"><p style="margin:5px 0px 20px 0px;"><span style="font-weight:600;font-size:2.357em;color:rgba(245,247,246,1);background-color:purple;">&nbsp;&nbsp;¡Nunca dejes de luchar por tus objetivos!&nbsp;&nbsp;</span></p><p style="margin:5px 0px 10px 0px;"><span style="font-size:1.714em;color:white;">Compra tu plan ahora y comienza tu cambio</span></p><p style="margin:5px 0px 50px 0px;"><span style="font-size:1.571em;color:rgba(52,52,52,1);"> </span><span style="font-weight:600;font-size:1.857em;color:rgba(81,160,131,1);"></span></p><p style="margin:5px 0px 30px 0px;"><span><a href="planes.html" target="_self" class="btn btn-md btn-default">AQUÍ</a>></span></p><br /></div>
</div>
</div>
</li>
</ul>
...
<?php else: ?>
<div class="cell4 col-xl-3 col-lg-3 col-md-6 col-sm-12  col-xs-12 col-12" style="background-color:purple;">
&nbsp;
</div>
<?php endif; ?>
<div class=" visible-lg-block d-xl-block d-lg-block visible-md-block d-md-block visible-sm-block d-sm-block visible-xs-block d-block" style="clear:both;"></div>
