...
<?php
// Ayush : managed condition for checking if posticon exist or not
if (file_exists('JURI::base() . "templates/" . $app->getTemplate()."/images/posticon.png"')) : ?>
<img src="<?php echo (JURI::base() . 'templates/' . $app->getTemplate().'/images/posticon.png')?>" alt="posticon" />
<?php endif; ?>
