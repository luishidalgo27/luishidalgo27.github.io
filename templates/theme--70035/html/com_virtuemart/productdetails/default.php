...
<div class="productdetails-view productdetails" >
	...
	<div style="clear:both;">
		<ul class="ttr_prodes_Tab_Title nav nav-tabs" >
			<li class="">
				<a class="nav-link active" href="#home" data-toggle="tab"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></a>
			</li>
			<li>
				<a class="nav-link" href="#menu1" data-toggle="tab"><?php echo vmText::_('COM_VIRTUEMART_SPECIFICATIONS') ?></a>
			</li>
			<li>
				<a class="nav-link" href="#menu2" data-toggle="tab"><?php echo vmText::_ ('COM_VIRTUEMART_REVIEWS') ?></a>
			</li>
		</ul>
